...
> Открыть эту страницу в [https://mrr0ck.github.io/23--autosignals/](https://mrr0ck.github.io/23--autosignals/)
...
* найдите **https://github.com/mrr0ck/23--autosignals** и импортируйте

## Править этот проект ![Значок статуса сборки](https://github.com/mrr0ck/23--autosignals/workflows/MakeCode/badge.svg)

Редактировать этот репозиторий в MakeCode.

* открыть [https://makecode.microbit.org/](https://makecode.microbit.org/)
* нажмите на **Импорт**, затем **Импорт URL**
* вставьте **https://github.com/mrr0ck/23--autosignals** и нажмите Импорт
...
![Отрисовка в виде блоков](https://github.com/mrr0ck/23--autosignals/raw/master/.github/makecode/blocks.png)
